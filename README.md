...
有公开安装方式或在线入口，并在核验时仍有近期维护活动的完整客户端。

- **[维C酒吧](https://appgallery.huawei.com/apptest/8zUVLkyBGOu)** · 第三方 · 公开测试 · HarmonyOS
  作者：<a href="https://cc98.shellraining.xyz/user/id/818074">infvar</a> · 原生 HarmonyOS 的沉浸式 CC98 第三方客户端 · 测试至 2026-10-26 · [安装教程帖](https://cc98.shellraining.xyz/topic/6585411) · [客户端展示帖](https://cc98.shellraining.xyz/topic/6584573) · 许可证：未发现声明 · 核验：2026-07-29
- **[shellRaining/cc98](https://github.com/shellRaining/cc98)** · 第三方 · 公开测试 · Web
  作者：<a href="https://github.com/shellRaining">shellRaining</a> · 面向多设备的现代 CC98 Web 客户端 · [在线体验](https://cc98.shellraining.xyz) · [开发记录帖](https://cc98.shellraining.xyz/topic/6572979) · 许可证：MIT · 核验：2026-07-29
- **[CC98 Desktop](https://apps.microsoft.com/detail/9NJ1LFJ8CDQ0?hl=zh-cn&gl=CN)** · 第三方 · 稳定 · Windows
  作者：<a href="https://github.com/Ansherly">Ansherly</a> · 使用 WinUI 3 与 Fluent Design 构建的 Windows 桌面客户端 · [GitHub](https://github.com/Ansherly/CC98-Desktop) · [GitHub 预览版](https://github.com/Ansherly/CC98-Desktop/releases/tag/v1.2.6) · [开发记录帖](https://cc98.shellraining.xyz/topic/6173309) · 许可证：未发现声明 · 核验：2026-07-29

## 浏览器、编辑器与终端体验

通过终端、浏览器、编辑器或伪装界面访问和增强 CC98。

- **[CC98 Reborn](https://github.com/Coran-tech/cc98-reborn)** · 第三方 · 公开测试 · Chrome / Edge
  作者：<a href="https://github.com/Coran-tech">Coran-tech</a> · 在保留原站能力的同时重塑 CC98 浏览界面 · [v0.2.10.1](https://github.com/Coran-tech/cc98-reborn/releases/tag/v0.2.10.1) · 许可证：MIT · 核验：2026-07-29
- **[CC98-CLI](https://www.npmjs.com/package/cc98-cli)** · 第三方 · 公开测试 · 终端
  作者：<a href="https://github.com/Lucent-Snow">Lucent-Snow</a> · 同时面向日常浏览和脚本调用的 CC98 终端客户端 · [GitHub](https://github.com/Lucent-Snow/CC98-CLI) · [v0.7.1](https://github.com/Lucent-Snow/CC98-CLI/releases/tag/v0.7.1) · 许可证：MIT · 核验：2026-07-29
- **[CC98-CLI](https://www.npmjs.com/package/@walavave/cc98-cli)** · 派生项目 · 公开测试 · 终端
  作者：<a href="https://github.com/walavave">walavave</a> · 带有 Yazi 风格界面和终端图片支持的 CC98 TUI · [GitHub](https://github.com/walavave/CC98-CLI) · [v0.3.0](https://github.com/walavave/CC98-CLI/releases/tag/v0.3.0) · 许可证：MIT · 核验：2026-07-29
- **[CC98 低调浏览](https://github.com/amiongogo/cc98-vscode)** · 第三方 · 公开测试 · VS Code
  作者：<a href="https://github.com/amiongogo">季风</a> · 把 CC98 帖子变成 VS Code 中的 Markdown 笔记 · [VSIX v0.1.8](https://github.com/amiongogo/cc98-vscode/releases/tag/v0.1.8) · 许可证：MIT · 核验：2026-07-29
- **[CC98 摸鱼模式](https://github.com/amiongogo/cc98-wps-table-disguise)** · 第三方 · 公开测试 · Web
  作者：<a href="https://github.com/amiongogo">季风</a> · 将 CC98 页面伪装成 WPS 或 Excel 表格的用户脚本 · [Greasy Fork](https://greasyfork.org/zh-CN/scripts/585813) · 许可证：MIT · 核验：2026-07-29
- **[CC98 Live Better](https://github.com/YangShu233-Snow/cc98-live-better)** · 第三方 · 公开测试 · Chrome / Edge / Firefox
  作者：<a href="https://github.com/YangShu233-Snow">YangShu233-Snow</a> · 为多账号、表情、历史记录和私信而作的 CC98 增强扩展 · [v0.1.7](https://github.com/YangShu233-Snow/cc98-live-better/releases/tag/v0.1.7) · 许可证：MIT · 核验：2026-07-29
- **[CC98 Cleaner](https://github.com/Aleph-000/cc98-cleaner)** · 第三方 · 稳定 · Edge / Chrome
  作者：<a href="https://github.com/Aleph-000">Aleph-000</a> · 在本地识别并过滤 CC98 高戾气评论的浏览器扩展 · [v1.0.8](https://github.com/Aleph-000/cc98-cleaner/releases/tag/v1.0.8) · 许可证：未发现声明 · 核验：2026-07-29

## 预览与实验项目

已有源码或早期产物，但功能、平台覆盖或维护状态仍不适合写成稳定版本。

- **[CC98-Ocean](https://github.com/Ansherly/CC98-Ocean/releases/tag/v0.0.1%2CCannary)** · 第三方 · 实验性 · Android
  作者：<a href="https://github.com/Ansherly">Ansherly</a> · 由 Flutter 驱动的 CC98 跨平台客户端计划 · [GitHub](https://github.com/Ansherly/CC98-Ocean) · 许可证：未发现声明 · 核验：2026-07-29
- **[CC98 Web Rewrite](https://github.com/mise42/cc98-web-rewrite)** · 派生项目 · 实验性 · Web
  作者：<a href="https://github.com/mise42">mise42</a> · 使用 React 19 与 TanStack 重写官方 Web 前端的实验项目 · 许可证：未发现声明 · 核验：2026-07-29

## 官方参考实现

用于理解当前和历史 CC98 界面的官方前端，不与第三方客户端混排。

- **[CC98 Forum](https://www.cc98.org/)** · 官方参考 · 稳定 · Web
  作者：<a href="https://github.com/ZJU-CC98">ZJU-CC98</a> · CC98 官方桌面网页前端 · [源码](https://github.com/ZJU-CC98/Forum) · [v3.2.0](https://github.com/ZJU-CC98/Forum/releases/tag/3.2.0) · 许可证：Apache-2.0 · 核验：2026-07-29
- **[CC98-PWA](https://m.cc98.org/)** · 官方参考 · 状态待确认 · PWA
  作者：<a href="https://github.com/ZJU-CC98">ZJU-CC98</a> · CC98 官方移动 PWA 实现 · [源码](https://github.com/ZJU-CC98/CC98-PWA) · [2026 使用指南](https://zjuers.com/welcome/cc98/cc98/) · 许可证：MIT · 核验：2026-07-29

## 客户端历史馆

已停止维护或只保留历史源码和旧安装包的客户端与原型。

- **[MyCC98](https://github.com/ZJU-CC98/MyCC98)** · 第三方 · 历史项目 · Android
  作者：<a href="https://github.com/djj0809">DJ</a>、<a href="https://github.com/zsy056">zsy</a> · 早期面向 Android 的 CC98 原生客户端 · [GitHub Releases](https://github.com/ZJU-CC98/MyCC98/releases) · 许可证：Apache-2.0 · 核验：2026-07-29
- **[CC98Lite](https://github.com/lunarfire/CC98Lite)** · 第三方 · 历史项目 · iOS
  作者：<a href="https://github.com/lunarfire">Lunarfire</a> · 2015 年面向 iPhone 的轻量 CC98 客户端 · 许可证：MIT · 核验：2026-07-29
- **[MyCC98 for iPhone](https://github.com/biaobiaoqi/MyCC98)** · 第三方 · 历史项目 · iOS
  作者：<a href="https://github.com/biaobiaoqi">biaobiaoqi</a> · iOS 6 与越狱时代的 CC98 iPhone 客户端 · 许可证：GPL-3.0 · 核验：2026-07-29
- **[CC98.u](https://github.com/Yutyrannus/CC98.u)** · 第三方 · 历史项目 · Android / Windows
  作者：<a href="https://github.com/Yutyrannus">Yutyrannus</a> · 同时发布 Android 与 UWP 版本的 Ionic 客户端 · [GitHub Releases](https://github.com/Yutyrannus/CC98.u/releases) · 许可证：MIT · 核验：2026-07-29
- **[CC98-iOS](https://github.com/YuwenXiong/CC98-iOS)** · 第三方 · 历史项目 · iOS
  作者：<a href="https://github.com/YuwenXiong">YuwenXiong</a> · 内置 RVPN 访问能力的 Swift iOS 客户端实验 · 许可证：未发现声明 · 核验：2026-07-29
- **[cc98-ionic](https://github.com/haoqunjiang/cc98-ionic)** · 第三方 · 历史项目 · iOS / Android
  作者：<a href="https://github.com/haoqunjiang">haoqunjiang</a> · 基于 Ionic 与 CC98 API 的早期混合移动客户端 · 许可证：BSD-3-Clause · 核验：2026-07-29
- **[MyNewCC98](https://github.com/6769/MyNewCC98)** · 第三方 · 历史项目 · Android
  作者：<a href="https://github.com/6769">6769</a> · 围绕 CC98 API v2 重写的实验性 Android 客户端 · [GitHub Releases](https://github.com/6769/MyNewCC98/releases) · 许可证：未发现声明 · 核验：2026-07-29
- **[CC98-APP](https://github.com/Zhytou/CC98-APP)** · 第三方 · 历史项目 · Android
  作者：<a href="https://github.com/Zhytou">Zhytou</a> · 复现 CC98 微信小程序功能的 Flutter 课程项目 · 许可证：未发现声明 · 核验：2026-07-29
- **[CC98.r](https://github.com/Yutyrannus/react-native-CC98)** · 第三方 · 历史项目 · Android
  作者：<a href="https://github.com/Yutyrannus">Yutyrannus</a> · 2016 年基于 React Native 的 Android 客户端实验 · 许可证：未发现声明 · 核验：2026-07-29
- **[such98](https://github.com/cruise1008/such98)** · 第三方 · 历史项目 · Android
  作者：<a href="https://github.com/cruise1008">cruise1008</a> · 因早期 Token API 问题暂停的 Android 客户端实验 · 许可证：GPL-2.0 · 核验：2026-07-29
...
新增项目、状态更新和链接纠错请阅读 [CONTRIBUTING.md](CONTRIBUTING.md)。展品事实保存在 `exhibits/<id>/exhibit.yaml`，README 的分组与顺序保存在 `collections/readme.yaml`。

## 许可证

生成脚本和其他代码使用 MIT License。目录文字及结构化元数据使用 CC0-1.0。项目名称、商标、截图和第三方素材仍归各自权利人所有，具体范围见 [NOTICE.md](NOTICE.md) 和 [素材规则](docs/assets.md)。
